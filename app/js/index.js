...
　　　　$(".content").mCustomScrollbar({
        ...
        function tabsToggle(res){
            $.each(res,function(i){
                var newsl = $('<div class="news-item"><div class="img img-pt"><a href="javascript:;"><img src="'+ res[i].img +'" alt="">'
                        +'</a></div><h1><a href="'+res[i].url+'" target="_blank">'+ res[i].title+'</a>'
                        +'</h1><div class="tags tags-pt"><span class="tags-box"></span><div class="time">'+ res[i].time +'</div></div></div>');
